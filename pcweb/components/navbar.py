...
def avata_button():
    return rx.center(
        rx.avatar(name="Wan Kim", size="sm"),
        box_shadow="0px 0px 0px 1px rgba(84, 82, 95, 0.14), 0px 1px 2px rgba(31, 25, 68, 0.14);",
        # display=["none", "none", "none", "flex", "flex", "flex"],
        display=["none", "flex", "flex", "flex", "flex"],
        height="2em",
            ...
            rx.hstack(
                rx.hstack(
                    ...
                    rx.menu(
                        rx.menu_button(
                            rx.hstack(
                                rx.text("입력", style=styles.NAV_TEXT_STYLE),
                                rx.icon(
                        ...
                        rx.menu_list(
                            rx.link(
                                rx.menu_item(
                                    "교과 성취 기준", style=styles.NAV_DROPDOWN_STYLE
                                ),
                                href="/input/subject_concept",
                            ),
                            rx.link(
                                rx.menu_item(
                                    "교과 채점 기준", style=styles.NAV_DROPDOWN_STYLE
                                ),
                                href="/input/subject_grading_criteria",
                            ),
                            rx.link(
                                rx.menu_item(
                                    "역량 채점 기준", style=styles.NAV_DROPDOWN_STYLE
                                ),
                                href="/input/ability_grading_criteria",
                            ),
                            rx.menu_divider(),
                            rx.link(
                                rx.menu_item(
                                    "학생 점수 입력", style=styles.NAV_DROPDOWN_STYLE
                                ),
                                href="/input/subject_concept",
                            ),
                        ),
                    ...
                    rx.menu(
                        rx.menu_button(
                            rx.hstack(
                                rx.text("출력", style=styles.NAV_TEXT_STYLE),
                                rx.icon(
                                    tag="chevron_down", style=styles.NAV_TEXT_STYLE
                                ),
                                cursor="pointer",
                        ...
                        rx.menu_list(
                            rx.link(
                                rx.menu_item(
                                    "교과 및 역량 기준", style=styles.NAV_DROPDOWN_STYLE
                                ),
                                href="/output/subject_concept",
                            ),
                            rx.link(
                                rx.menu_item(
                                    "학생별 피드백", style=styles.NAV_DROPDOWN_STYLE
                                ),
                                href="/output/subject_concept",
                            ),
                            rx.link(
                                rx.menu_item(
                                    "교과별 피드백", style=styles.NAV_DROPDOWN_STYLE
                                ),
                                href="/output/subject_concept",
                            ),
                        ),
                    ...
                    #     display=["none", "none", "none", "flex", "flex", "flex"],
                    # ),
                    # rx.icon(tag="drag_handle", style=styles.NAV_TEXT_STYLE),
                    # rx.link(
                    #     "학생별 피드백",
                    #     href="/docs/getting-started/introduction",
                    #     style=styles.NAV_TEXT_STYLE,
                    ...
                    rx.menu(
                        rx.menu_button(
                            rx.hstack(
                                rx.text("기타", style=styles.NAV_TEXT_STYLE),
                                rx.icon(
                                    tag="chevron_down", style=styles.NAV_TEXT_STYLE
                                ),
                                cursor="pointer",
                        ...
                        rx.menu_list(
                            rx.link(
                                rx.menu_item(
                                    "성취기준", style=styles.NAV_DROPDOWN_STYLE
                                ),
                                href="/changelog",
                            ),
                            # rx.link(
