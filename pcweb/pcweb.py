...
# from pcweb.pages import blog_routes, doc_routes, routes, faq_routes, changelog_routes, input_routes, output_routes
from pcweb.pages import routes, input_routes, output_routes
