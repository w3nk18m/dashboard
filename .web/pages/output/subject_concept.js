...
import { Avatar, Box, Center, Container, Divider, Drawer, DrawerContent, DrawerOverlay, Heading, HStack, Image, Link, Menu, MenuButton, MenuDivider, MenuItem, MenuList, Modal, ModalBody, ModalContent, ModalHeader, ModalOverlay, Spacer, Text, VStack } from "@chakra-ui/react"
...
export default function Component() {
  ...
  <Box>
  <DataTableGrid columns={state.subjec_oouput_state.table_subject_concept_col} data={state.subjec_oouput_state.table_subject_concept_data} pagination={true} search={true} sort={true}/>
</Box>
  <Box sx={{"textAlign": "left", "width": "100%"}}>
  <Heading sx={{"fontSize": ["2.2em", "2.4em", "2.5em"], "mt": 12, "mb": 4, "fontFamily": "Instrument Sans"}}>
  {`교과 채점 기준`}
  ...
  <Box>
  <DataTableGrid columns={state.subjec_oouput_state.table_subject_criteria_col} data={state.subjec_oouput_state.table_subject_criteria_data} pagination={true} search={true} sort={true}/>
</Box>
  <Box sx={{"textAlign": "left", "width": "100%"}}>
  <Heading sx={{"fontSize": ["2.2em", "2.4em", "2.5em"], "mt": 12, "mb": 4, "fontFamily": "Instrument Sans"}}>
  {`역량 채점 기준`}
  ...
  <Box>
  <DataTableGrid columns={state.subjec_oouput_state.table_ability_criteria_col} data={state.subjec_oouput_state.table_ability_criteria_data} pagination={true} search={true} sort={true}/>
</Box>
</VStack>
</Container>
