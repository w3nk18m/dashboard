...
import { Avatar, Box, Center, Code, Drawer, DrawerContent, DrawerOverlay, Heading, HStack, Image, Link, Menu, MenuButton, MenuDivider, MenuItem, MenuList, Modal, ModalBody, ModalContent, ModalHeader, ModalOverlay, Spacer, Text, VStack } from "@chakra-ui/react"
...
export default function Component() {
  ...
  <Fragment>
  <Box sx={{"fontFamily": "Instrument Sans", "width": "100vw"}}>
  ...
  <Center sx={{"height": "80vh", "width": "100%"}}>
  <VStack>
  <Heading sx={{"fontFamily": "Instrument Sans"}}>
  {`404 - Not Found`}
</Heading>
  <Text sx={{"fontFamily": "Instrument Sans", "fontSize": 16}}>
  {`Oups, the page at `}
  <Code sx={{"color": "#1F1944", "bg": "#EAE4FD"}}>
  {state.state404.origin_url}
</Code>
  {` doesn't exist.`}
</Text>
  <Spacer/>
